            ...
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                <div class="p-6 text-gray-900">
                    <form method="post" action="{{ route('customers.update', $customer->id) }}" class="mt-6 space-y-6">
                        ...
                        <div>
                            <x-input-label for="addr_number" :value="__('addr_number')" />
                        ...
                        <div>
                            <x-input-label for="addr_street" :value="__('addr_street')" />
                        ...
                        <div>
                            <x-input-label for="addr_city" :value="__('addr_city')" />
                        ...
                        <div>
                            <x-input-label for="addr_postcode" :value="__('addr_postcode')" />
